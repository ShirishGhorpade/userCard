...
const Navbar = () => {
  ...
  //     const data1 = await fetch('https://reqres.in/api/users?page=1')
  //     const findata = (await data1.json()).data;
  ...
  return (
    <>
      ...
      <div className="container" style={{ display: "grid", gridTemplateColumns: 'auto auto auto', rowGap: '20px', margin: 'auto', backgroundColor: '#236' }}>{
